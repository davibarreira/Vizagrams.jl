...
@testset "Polygons" begin
    ...
    @testset "QBezierPolygon" begin
        @testset "Constructor" begin
            @test all(
                QBezierPolygon([[0.2, 0], [1, 0]], [[1.0, 1], [0.5, -1]]).bpts .==
                [[0.2, 0.0], [1, 0]],
            )
            @test all(
                QBezierPolygon([[0.2, 0], [1, 0]], [[1.0, 1], [0.5, -1]]).cpts .==
                [[1.0, 1], [0.5, -1]],
            )
        end
        ...
        @testset "act" begin
            @test all(
                act(g, QBezierPolygon([[0.2, 0], [1, 0]], [[1.0, 1], [0.5, -1]])).bpts .==
                [[1.2, 1], [2, 1]],
            )
            @test all(
                act(g, QBezierPolygon([[0.2, 0], [1, 0]], [[1.0, 1], [0.5, -1]])).cpts .==
                [[2, 2], [1.5, 0]],
            )
        end
    end
    ...
    @testset "CBezierPolygon" begin
        @testset "Constructor" begin
            ...
            @test all(
                CBezierPolygon(
                    [[0, 0], [0, 1], [0, 0]],
                    [[-1, 0.8], [0, 1], [1, 1], [1, 1], [0, 1], [1, 0.8]],
                ).cpts .== [[-1, 0.8], [0, 1], [1, 1], [1, 1], [0, 1], [1, 0.8]],
            )
        end
        ...
        @testset "act" begin
            ...
            @test all(
                ...
                ).cpts .== [[-0, 1.8], [1, 2], [2, 2], [2, 2], [1, 2], [2, 1.8]],
            )
        end
    end
end
