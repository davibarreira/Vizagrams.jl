...
Observable Plot [@observable_plot], Atlas [@liu2021atlas],
[AlgebraOfGraphics.jl](https://github.com/MakieOrg/AlgebraOfGraphics.jl)). There are also specialized visualization grammars, such as
